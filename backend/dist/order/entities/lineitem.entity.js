...
__decorate([
    (0, typeorm_1.ManyToOne)(() => order_entity_1.Order, (order) => order.lineItems, { onDelete: 'CASCADE' }),
...
__decorate([
    ...
    __metadata("design:type", Number)
], LineItem.prototype, "unitPrice", void 0);
__decorate([
    (0, typeorm_1.Column)('decimal', { precision: 10, scale: 2 }),
    __metadata("design:type", Number)
...
], LineItem.prototype, "createdAt", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)(),
    __metadata("design:type", Date)
], LineItem.prototype, "updatedAt", void 0);
exports.LineItem = LineItem = __decorate([
    (0, typeorm_1.Entity)()
], LineItem);
//# sourceMappingURL=lineitem.entity.js.map